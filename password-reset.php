...
<?php
    if(isset($_POST['Submit'])){
        ...
        $result=$mysqli->query("SELECT * FROM members WHERE login='$email'")
...
<?php
    if(isset($_POST['Change'])){
        ...
        if(trim($_SESSION['member_id']) != ''){
         ...
         // update the entry
         $result = $mysqli->query("UPDATE members SET passwd='".md5($_POST['new_password'])."' WHERE member_id='$member_id' AND answer='".md5($_POST['answer'])."'")
         or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours. \n");  
...
<title><?php echo "Food Plaza"; ?>:Password Reset</title>
...
<div id="reset">
  ...
  <?php
    if(isset($_POST['Submit'])){
        ...
        $question=$mysqli->query("SELECT * FROM questions WHERE question_id='$question_id'")
        or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours.");
