...
<?php
    if(isset($_POST['Submit'])){
        ...
        $result=$mysqli->query("SELECT * FROM food_details WHERE food_category='$id'")
        or die("A problem has occured ... \n" . "Our team is working on it at the moment ... \n" . "Please check back after few hours."); 
    }
?>
<?php
...
<?php
    ...
    $flag_0 = 0;
    $items=$mysqli->query("SELECT * FROM cart_details WHERE member_id='$member_id' AND flag='$flag_0'")
    or die("Something is wrong ... \n" . mysql_error()); 
?>
<?php
...
<title><?php echo "Food Plaza"; ?>:Shopping Cart</title>
