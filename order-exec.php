...
$mysqli->select_db($database) or die( "Unable to select database");
    ...
    $qry_select=$mysqli->query("SELECT * FROM billing_details WHERE member_id='$member_id'")
    ...
    if(mysqli_num_rows($qry_select)>0 && isset($_GET['id'])){
            ...
            $timezones=$mysqli->query("SELECT * FROM timezones WHERE flag='$flag_1'")
